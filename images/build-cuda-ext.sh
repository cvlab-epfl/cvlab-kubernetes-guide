...
docker build lab-sleeper-addon \
	--build-arg BASE_IMG=ic-registry.epfl.ch/cvlab/lis/lab-pytorch-apex:latest \
	-t ic-registry.epfl.ch/cvlab/lis/lab-pytorch-apex:sleeper
...
docker tag ic-registry.epfl.ch/cvlab/lis/lab-pytorch-apex:latest ic-registry.epfl.ch/cvlab/lis/lab-pytorch-apex:sleeper
docker push ic-registry.epfl.ch/cvlab/lis/lab-pytorch-apex:sleeper
